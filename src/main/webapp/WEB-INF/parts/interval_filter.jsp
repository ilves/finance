<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills">
            ...
            <li class="<c:if test="${period eq 'last12'}">active</c:if>"><a href="?period=last12&step=${step}">Last 12 Months</a></li>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <ul class="nav nav-pills">
            <li class="<c:if test="${cum eq '1'}">active</c:if>"><a href="?step=${step}&period=${period}&cum=1">Cumulative</a></li>
        </ul>
    </div>
</div>